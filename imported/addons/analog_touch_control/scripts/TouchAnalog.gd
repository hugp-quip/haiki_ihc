...
@export var CircleTexture : Texture2D = preload("res://imported/addons/analog_touch_control/images/Circle.svg")
@export var KnobTexture : Texture2D = preload("res://imported/addons/analog_touch_control/images/Dot.svg")
